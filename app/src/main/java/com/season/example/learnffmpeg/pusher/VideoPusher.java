...
public class VideoPusher extends  Pusher implements SurfaceHolder.Callback,
    ...
    public void switchCamera() {
        if (mParam.getCameraId() == Camera.CameraInfo.CAMERA_FACING_BACK) {
            mParam.setCameraId(Camera.CameraInfo.CAMERA_FACING_FRONT);
        } else {
            mParam.setCameraId(Camera.CameraInfo.CAMERA_FACING_BACK);
        }
        stopPreview();
        startPreview();
    }
